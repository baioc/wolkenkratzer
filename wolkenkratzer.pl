...
%              [_,_,_,_]],
%    Board = [A,B,C,D],
%    wolkenkratzer(Board, ([0,0,4,0], [0,0,0,0], [0,2,0,0], [1,4,0,0]), 4).
%
...
%              [_,_,_,_]],
%    Board = [A,B,C,D],
%    wolkenkratzer(Board, ([0,0,0,1], [0,2,0,2], [0,0,3,0], [0,0,0,0]), 3).
%
...
%              [_,_,_,_]],
%    Board = [A,B,C,D],
%    wolkenkratzer(Board, ([0,0,0,0], [1,2,3,0], [0,0,0,0], [0,0,0,0]), 4).
% %
